...
class MapperTransformer(nn.Module):
    def __init__(
        self,
        n_heads,
        n_layers,
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, MapperTransformer):
...
model = MapperTransformer(n_heads=6, n_layers=6, n_embed=768, block_size=1024, n_vocab=50257, ignore_token=50256)
